...
const Footer = () => {
  return (
   <footer className="bg-gradient-to-r from-[#0f2027] via-[#203a43] to-[#2c5364] text-gray-300 py-10">
  <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-3 gap-8">
    {/* About */}
    <div>
      <h3 className="text-xl font-semibold mb-4 text-[#7ADAA5]">Fitness Tracker</h3>
    ...
    {/* Navigation Links */}
    <div>
      <h4 className="text-lg font-semibold mb-4 text-[#239BA7]">Quick Links</h4>
      <ul className="space-y-2">
        <li><a href="/" className="hover:text-[#7ADAA5] transition">Home</a></li>
        <li><a href="/features" className="hover:text-[#7ADAA5] transition">Features</a></li>
        <li><a href="/trainers" className="hover:text-[#7ADAA5] transition">Trainers</a></li>
        <li><a href="/blog" className="hover:text-[#7ADAA5] transition">Blog</a></li>
        <li><a href="/contact" className="hover:text-[#7ADAA5] transition">Contact</a></li>
      </ul>
    </div>

    {/* Contact & Social */}
    <div>
      <h4 className="text-lg font-semibold mb-4 text-[#CADCAE]">Contact Us</h4>
      <p className="text-gray-400">email@example.com</p>
      <p className="text-gray-400">+880 1234 567890</p>

      <div className="flex space-x-4 mt-4">
        <a href="https://facebook.com" aria-label="Facebook" className="hover:text-[#239BA7] transition">
        ...
        <a href="https://twitter.com" aria-label="Twitter" className="hover:text-[#7ADAA5] transition">
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
        ...
        <a href="https://instagram.com" aria-label="Instagram" className="hover:text-[#CADCAE] transition">
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
  ...
  <div className="text-center text-gray-400 mt-10 text-sm">
    &copy; {new Date().getFullYear()} <span className="text-[#7ADAA5]">Fitness Tracker</span>. All rights reserved.
  </div>
</footer>
